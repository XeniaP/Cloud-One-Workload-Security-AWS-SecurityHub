...
def addAdditionalInformation(EventType, finding):
        ...
        if "AntiMalwareEvent" in EventType:
            ...
            finding['StatusReasons']['Description'] = EventType['ScanResultString']
...
def workload_security_event_to_asff(ws_event, region, awsaccountid):
    ...
    finding = {
        ...
        "ProductArn": f"arn:aws:securityhub:{region}:{awsaccountid}:product/WorkloadSecurity/CloudOneWorkloadSecurity",
        ...
        "StatusReasons": [
            {
                "Description": "",
                "ReasonCode": ws_event['Reason'] if 'Reason' in ws_event else ''
                }
            ]
        }
                ...
                if 'Sns' in e:
                    ...
                    if ws_events:
                        ...
                        for ws_event in ws_events:
                            ...
                            total_events += 1
                            if ws_event['EventType'] != 'SystemEvent' and verify_required_properties(ws_event):
